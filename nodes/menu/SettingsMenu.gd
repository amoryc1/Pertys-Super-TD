...
func _on_save_pressed():
	get_node("../tapSFX").play()
	var x = GLOBALVAR_PTD.save_data(GLOBALVAR_PTD.chosenSaveFile)
	if x[0]: 
...
func _on_show_debug_pressed():
	get_node("../tapSFX").play()
	GLOBALVAR_PTD.showDebug = $advanced/showDebug.button_pressed
